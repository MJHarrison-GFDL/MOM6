...
integer, parameter :: REGRIDDING_HYCOM_LAT    = 11      !< Simple HyCOM coordinates without BBL
...
character(len=*), parameter :: REGRIDDING_HYCOM_LAT_STRING = "HYCOM_LAT" !< Hycom string
...
function coordinateMode(string)
  ...
  select case ( uppercase(trim(string)) )
    ...
    case (trim(REGRIDDING_HYCOM_LAT_STRING)); coordinateMode = REGRIDDING_HYCOM_LAT
...
function coordinateUnitsI(coordMode)
  ...
  select case ( coordMode )
    ...
    case (REGRIDDING_HYCOM_LAT); coordinateUnitsI = "m"
...
logical function state_dependent_int(mode)
  ...
  select case ( mode )
    ...
    case (REGRIDDING_HYCOM_LAT); state_dependent_int = .true.
