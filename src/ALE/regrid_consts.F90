...
integer, parameter :: REGRIDDING_HYCOM1_2D  = 7     !< 2-dimensional version of HYCOM1
...
character(len=*), parameter :: REGRIDDING_HYCOM1_STRING = "HYCOM1" !< Hycom1 string
character(len=*), parameter :: REGRIDDING_HYCOM1_2D_STRING = "HYCOM1_2D" !< Hycom1-2d string
...
function coordinateMode(string)
  ...
  select case ( uppercase(trim(string)) )
    ...
    case (trim(REGRIDDING_HYCOM1_2D_STRING)); coordinateMode = REGRIDDING_HYCOM1_2D
...
function coordinateUnitsI(coordMode)
  ...
  select case ( coordMode )
    ...
    case (REGRIDDING_HYCOM1_2D); coordinateUnitsI = "m"
...
logical function state_dependent_int(mode)
  ...
  select case ( mode )
    ...
    case (REGRIDDING_HYCOM1_2D); state_dependent_int = .true.
